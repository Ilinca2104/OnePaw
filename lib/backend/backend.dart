...
import 'schema/one_paw_record.dart';
...
export 'schema/one_paw_record.dart';
export 'schema/users_record.dart';
export 'schema/post_record.dart';
export 'schema/comments_record.dart';

/// Functions to query OnePawRecords (as a Stream and as a Future).
Future<int> queryOnePawRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      OnePawRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<OnePawRecord>> queryOnePawRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      OnePawRecord.collection,
      OnePawRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<OnePawRecord>> queryOnePawRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
