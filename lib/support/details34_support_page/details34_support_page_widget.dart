            ...
            body: SafeArea(
              ...
              child: Column(
                ...
                children: [
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                            Text(
                              FFLocalizations.of(context).getText(
                                '9b07v9wh' /* Welcome to the support section */,
                              ),
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        FFLocalizations.of(context).getText(
                                          'ya5d30i9' /* How can I adopt an animal? */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyLarge
                                            .override(
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            'ntr6o7my' /* Complete the adoption form or ... */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .labelMedium
                                              .override(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            'wo5at0sw' /* Using the application does not... */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .labelMedium
                                              .override(
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        FFLocalizations.of(context).getText(
                                          'yv5cvti8' /* What happens after completing ... */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyLarge
                                            .override(
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            '2181qpyb' /* After completing it, we will a... */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .labelMedium
                                              .override(
                  ...
                  Padding(
                    padding:
                        const EdgeInsetsDirectional.fromSTEB(16.0, 16.0, 16.0, 50.0),
                    child: FFButtonWidget(
                      onPressed: () async {
                        context.pushNamed('Mesajsuport');
                      },
                      text: FFLocalizations.of(context).getText(
                        'kkcbc858' /* Write us a message */,
                      ),
                      icon: const Icon(
                        Icons.receipt_long,
                        size: 15.0,
