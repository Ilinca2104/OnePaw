      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'Adoptionpage')
              : const AdoptionpageWidget(),
        ),
        FFRoute(
          name: 'Mesajsuport',
          path: '/mesajsuport',
          builder: (context, params) => const MesajsuportWidget(),
        ),
        FFRoute(
          name: 'FAQ',
          path: '/faq',
        ...
        FFRoute(
          ...
          asyncParams: {
            'commentparameter':
                getDoc(['users', 'post'], PostRecord.fromSnapshot),
          },
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'LostFound')
              : LostFoundWidget(
        ...
        FFRoute(
          ...
          path: '/likePosts',
          asyncParams: {
            'dddd': getDoc(['users', 'post'], PostRecord.fromSnapshot),
          },
          builder: (context, params) => LikePostsWidget(
        ...
        FFRoute(
          name: 'PrivacePolicy',
          path: '/privacePolicy',
          builder: (context, params) => const PrivacePolicyWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: 'Shelter1',
          path: '/shelter1',
          builder: (context, params) => const Shelter1Widget(),
        ),
        FFRoute(
          name: 'Shelter1Copy',
          path: '/shelter1Copy',
          builder: (context, params) => const Shelter1CopyWidget(),
        ),
        FFRoute(
          name: 'Shelter1Copy2',
          path: '/shelter1Copy2',
          builder: (context, params) => const Shelter1Copy2Widget(),
        ),
        FFRoute(
          name: 'Messagesent',
          path: '/messagesent',
          builder: (context, params) => const MessagesentWidget(),
        )
