            ...
            body: Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  fit: BoxFit.cover,
                  image: Image.asset(
                    'assets/images/1716196614673.png',
                  ).image,
                ),
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'jpehl8sv' /* Create an account by using the... */,
                                    ),
                                        ...
                                        text: TextSpan(
                                          children: [
                                            TextSpan(
                                              text: FFLocalizations.of(context)
                                                  .getText(
                                                'pvu82yu9' /* Already have an account?     */,
                                              ),
