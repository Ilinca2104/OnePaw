            ...
            body: Container(
              ...
              decoration: const BoxDecoration(
                gradient: LinearGradient(
                  colors: [Colors.white, Color(0xFFFF5205)],
                  stops: [0.0, 1.0],
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      '0nxag4n8' /* Fill out the information below... */,
                                    ),
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      context.pushNamedAuth(
                                          'Quiz1', context.mounted);
                                    },
                                    text: FFLocalizations.of(context).getText(
                                      'igvei0am' /* Continue with Google */,
                                    ),
                                    icon: const FaIcon(
                                        ...
                                        text: TextSpan(
                                          children: [
                                            TextSpan(
                                              text: FFLocalizations.of(context)
                                                  .getText(
                                                'y04zxbzx' /* Don't have an account?   */,
                                              ),
